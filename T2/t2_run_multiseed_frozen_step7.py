"""
=======================================================================
T2/t2_run_multiseed_frozen_step7.py  —  T2-Step7 Frozen 다중 Seed 실험
=======================================================================
...
[파일 위치]
  ...
  └── T2/
      ├── t2_textify.py
      └── t2_run_multiseed_frozen_step7.py  ← 이 파일
...
[출력 파일 구조]
  output/T2_frozen_step7/
    ├── t2_frozen_step7.log      # 전체 시드의 통합 훈련 타임라인 및 분산 프로세스 상태 로그
    ├── seed_0/
...
[실행 방법]
  ...
  # seed 지정
  python T2/t2_run_multiseed_frozen_step7.py --seeds {0..9} --gpu 3
=======================================================================
"""
...
def main():
    parser = argparse.ArgumentParser(description="T2-Step7 Frozen 다중 Seed 실험")
    # ── [추가] GPU 번호 지정을 위한 인자 ────────────────────────────────
    ...
    parser.add_argument("--eval_only", action="store_true",
                        help="학습 건너뛰고 평가만")
    parser.add_argument("--output_dir", default="output/T2_frozen_step7",
                        help="결과 저장 루트 디렉토리")
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler(f"{args.output_dir}/t2_frozen_step7.log"),
        ],
    )
